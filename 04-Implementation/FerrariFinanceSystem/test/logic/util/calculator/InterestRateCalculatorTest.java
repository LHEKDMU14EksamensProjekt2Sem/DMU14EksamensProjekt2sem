...
public class InterestRateCalculatorTest {
   ...
   @Test // TC-05
   public void testOvernight1PctCreditBDown50PctTerm37Gives4PctRate() {
      double overnightRate = 0.01;
      Rating creditRating = Rating.B;
      double downPaymentPct = 0.50;
      int term = 37;
   ...
   @Test // TC-06
   public void testOvernight1PctCreditBDown50PctTerm36Gives3PctRate() {
      double overnightRate = 0.01;
      Rating creditRating = Rating.B;
      double downPaymentPct = 0.50;
      int term = 36;
   ...
   @Test // TC-07
   public void testOvernight1PctCreditBDown20PctTerm37Gives5PctRate() {
      double overnightRate = 0.01;
      Rating creditRating = Rating.B;
      double downPaymentPct = 0.20;
      int term = 37;
   ...
   @Test // TC-08
   public void testOvernight1PctCreditBDown20PctTerm36Gives4PctRate() {
      double overnightRate = 0.01;
      Rating creditRating = Rating.B;
      double downPaymentPct = 0.20;
      int term = 36;
   ...
   @Test // TC-09
   public void testOvernight1PctCreditCDown50PctTerm37Gives5PctRate() {
      double overnightRate = 0.01;
   ...
   @Test // TC-10
   public void testOvernight1PctCreditCDown50PctTerm36Gives4PctRate() {
      double overnightRate = 0.01;
      Rating creditRating = Rating.C;
      double downPaymentPct = 0.50;
      int term = 36;
   ...
   @Test // TC-11
   public void testOvernight1PctCreditCDown20PctTerm37Gives6PctRate() {
      double overnightRate = 0.01;
      Rating creditRating = Rating.C;
      double downPaymentPct = 0.20;
      int term = 37;
   ...
   @Test // TC-13
   public void testOvernight1PctCreditADown49Point99PctTerm37Gives4PctRate() {
      double overnightRate = 0.01;
      Rating creditRating = Rating.A;
      double downPaymentPct = 0.4999;
      int term = 37;
   ...
   @Test // TC-14
   public void testOvernight1PctCreditADown99Point99PctTerm37Gives3PctRate() {
      double overnightRate = 0.01;
      Rating creditRating = Rating.A;
      double downPaymentPct = 0.9999;
      int term = 37;
   ...
   @Test // TC-15
   public void testOvernight1PctCreditADown50PctTerm1Gives2PctRate() {
      double overnightRate = 0.01;
      Rating creditRating = Rating.A;
      double downPaymentPct = 0.50;
      int term = 1;
   ...
   @Test // TC-23
   public void testNaNDownPaymentPctThrowsIllegalArgumentException() {
      thrown.expect(IllegalArgumentException.class);
      thrown.expectMessage("Down payment pct. cannot be Double.NaN");

      double overnightRate = 0.01;
      Rating creditRating = Rating.A;
      double downPaymentPct = Double.NaN;
      int term = 37;
